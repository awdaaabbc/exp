"""Run the HGD Model3 training script on the last 6 subjects by default."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Train Model3 on HGD subjects 9-14 by default.")
    parser.add_argument("--config", default="config/hgd_model3.yaml", help="Path to yaml config.")
    parser.add_argument("--subjects", default="9-14", help="Override subjects, for example 9-14.")
